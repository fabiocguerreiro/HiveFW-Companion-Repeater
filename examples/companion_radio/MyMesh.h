...
// Resultado de uma pesquisa DISCOVER real.
// Independente da tabela AdvertPath.
...
public:
  ...
  // Resultados de Discovery ativo.
  void clearNodeDiscoveryResults();
  int getNodeDiscoveryResults(NodeDiscoveryResult dest[], int max_num);
...
private:
  ...
  uint32_t pending_node_name_tag;

  static const uint8_t NODE_DISCOVERY_RESULTS_MAX = 8;
  NodeDiscoveryResult node_discovery_results[NODE_DISCOVERY_RESULTS_MAX];
  uint8_t node_discovery_result_count;
